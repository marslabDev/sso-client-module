        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route("profile.password.updateProfile") }}">
                    ...
                    <div class="form-group">
                        <label class="required" for="title">{{ trans('ssoclient::cruds.user.fields.email') }}</label>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route("profile.password.update") }}">
                    @csrf
                    <div class="form-group">
                        <label class="required" for="title">New {{ trans('ssoclient::cruds.user.fields.password') }}</label>
                    ...
                    <div class="form-group">
                        <label class="required" for="title">Repeat New {{ trans('ssoclient::cruds.user.fields.password') }}</label>
